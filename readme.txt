...
### 1. Synthetic_echelle_diagram.py: description in readme_Synthetic_echelle_diagram.txt

This program produces as an output the plot synthetic_echelle_dnurot_dnumag.pdf.


### 2. Stretching_spectrum.py: description in readme_Stretching_spectrum.txt
...
### 3. Core_rotation_measurement.py: description in readme_Core_rotation_measurement.txt
...
### 4. Results.py: description in readme_Results.txt
